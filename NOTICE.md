# Content and brand notice

Copyright 2026 RFID INC. All rights reserved.

The MIT terms in `LICENSE-CODE` apply only to website source code and the public orbital-screening software. They do not grant rights to:

- the Satellite Inference name, wordmark, logo, or visual identity;
