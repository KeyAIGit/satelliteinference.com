...
const cadSource = path.join(projectRoot, "public/assets/cad/flight-demonstrator-deployed.png");
...
const overlay = Buffer.from(`
  <svg width="1200" height="630" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="61" y="254" class="sans" fill="#f3fbff" font-size="62" font-weight="500">Compute where</text>
    <text x="61" y="326" class="sans" fill="#f3fbff" font-size="62" font-weight="500">space data begins.</text>
    <text x="63" y="397" class="sans" fill="#9db2c0" font-size="22">From hosted flight evidence to owned orbital nodes.</text>
    <text x="63" y="565" class="mono" fill="#ffbd4a" font-size="12" font-weight="700" letter-spacing="1">FLIGHT DEMONSTRATOR / REV B CONCEPT</text>
