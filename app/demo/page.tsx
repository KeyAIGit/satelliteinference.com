    ...
    <main className={styles.page}>
      ...
      <section className={styles.hero} id="top" aria-labelledby="demo-title">
        ...
        <div className={styles.heroCopy}>
          ...
          <h1 id="demo-title">Start with SAR maritime.<br />Test the assumptions.</h1>
          ...
          <div className={styles.heroActions}>
            <a href="#demo-content" className={styles.primaryAction}>Open the workload screen <ArrowDown size={16} /></a>
      ...
      <section className={styles.labSection} id="demo-content" tabIndex={-1}>
        <header className={styles.sectionHeader}>
          <div>
            ...
            <h2>Read the workloads.<br />See only what arithmetic supports.</h2>
          </div>
          <p>
