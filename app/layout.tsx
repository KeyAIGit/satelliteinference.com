...
export const metadata: Metadata = {
  ...
  description:
    "A 10 kW continuous-compute node in low Earth orbit for defense, Earth-observation, maritime, and disaster-response data.",
  ...
  openGraph: {
    ...
    description: "A 10 kW continuous-compute node in low Earth orbit, developed through a planned 1 kW ground-validation tile.",
